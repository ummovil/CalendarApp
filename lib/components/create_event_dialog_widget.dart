...
import 'create_event_dialog_model.dart';
export 'create_event_dialog_model.dart';

class CreateEventDialogWidget extends StatefulWidget {
  const CreateEventDialogWidget({
    Key? key,
  ...
  @override
  _CreateEventDialogWidgetState createState() =>
      _CreateEventDialogWidgetState();
}

class _CreateEventDialogWidgetState extends State<CreateEventDialogWidget> {
  late CreateEventDialogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CreateEventDialogModel());
